...
let userCookie = ($.isNode() ? process.env.wbtcCookie : $.getdata('wbtcCookie')) || 'PPU=UID=91644354371093&UN=0fm620mbn&TT=b8e1fcb46e85a598a7832637faa942a0&PBODY=VQQYDTWxaZJBPMagLu0sg9-UVk-KTge7n3CQkQs39JMSgbg-85A-iPpMLE901X4B40n9JuBk2dpt43nslvEvciD8h5Mgu3jaa8vXmm7ke28uDKcTdMCUXYSOtQ9gDV7hDhu-qntF5DoZD4HKSwEoqfTMtWNX87F-Q3hrQAZH8ZU&VER=1&CUID=tRQohwfHpIOBgBVlDJzNYg#1';
let userUA = ($.isNode() ? process.env.wbtcUA : $.getdata('wbtcUA')) || 'Mozilla/5.0 (Linux; Android 10.1.0) AppleWebKit/5.82 (KHTML, like Gecko) Firefox/66.0 Safari/600.53';
let userCookieArr = []
let userList = []
