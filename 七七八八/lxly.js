 ...
 * 功能： 签到领取云盘容量
 * 抓取
 * pim.lenovo.com  域名下的任意Authorization 或者 x-lenovows-authorization
 ...
 */
 ...
 function signin(timeout = 3 * 1000) {
     return new Promise((resolve) => {
         let url = {
             url: `https://pim.lenovo.com/lesynch5/userspaceapi/v4/addspace?type=1&imei=${randomString(16)}&cvern=6.8.0.99&cverc=99060801&cpkg=com.lenovo.leos.cloud.sync&chid=PimWebPortal&version=v4`,    
             headers: { 
                "Host": "pim.lenovo.com",
         ...
         $.get(url, async (error, response, data) => {
             try {
                 ...
                 if (result.result == 0 && result.spaceadd != 0) {
 
                     console.log(`签到成功，获得:${result.spaceadd}MB`)
                     msg += `\n签到成功，获得:${result.spaceadd}MB`
 
                 } else if (result.result == 0 && result.spaceadd == 0) {
